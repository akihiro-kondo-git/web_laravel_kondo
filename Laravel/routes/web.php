...
Route::post('/result-regist', [ResultRegistController::class, 'index'])->name('result-regist');
Route::get('/refer-employee', [ReferEmployeeController::class, 'index'])->name('refer-employee');
Route::get('/edit-employee', [EditEmployeeController::class, 'index'])->name('edit-employee');
